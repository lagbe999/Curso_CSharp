...
namespace Taller_103_WPF_LINQ
{
    ...
    partial void DeleteCargo_Empleado(Cargo_Empleado instance);
		...
		public DataClasses1DataContext() : 
				base(global::Taller_103_WPF_LINQ.Properties.Settings.Default.CrudLinqSql, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Cargo_Empleado> Cargo_Empleado
		{
			get
			{
	...
	public partial class Empleado : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Cargo_Empleado> _Cargo_Empleado;
    ...
    partial void OnEmpresaIdChanged();
		...
		public Empleado()
		{
			this._Cargo_Empleado = new EntitySet<Cargo_Empleado>(new Action<Cargo_Empleado>(this.attach_Cargo_Empleado), new Action<Cargo_Empleado>(this.detach_Cargo_Empleado));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Empleado_Cargo_Empleado", Storage="_Cargo_Empleado", ThisKey="Id", OtherKey="EmpleadoId")]
		public EntitySet<Cargo_Empleado> Cargo_Empleado
		{
			get
			{
			...
			set
			{
				this._Cargo_Empleado.Assign(value);
			}
		}
		...
		private void attach_Cargo_Empleado(Cargo_Empleado entity)
		{
			this.SendPropertyChanging();
			entity.Empleado = this;
		}
		
		private void detach_Cargo_Empleado(Cargo_Empleado entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnNombreChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cargo_Cargo_Empleado", Storage="_Cargo_Empleado", ThisKey="Id", OtherKey="CargoId")]
		public EntitySet<Cargo_Empleado> Cargo_Empleado
		{
			get
			{
    ...
    partial void OnCargoIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cargo_Cargo_Empleado", Storage="_Cargo", ThisKey="CargoId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Cargo Cargo
		{
			get
			{
			...
			set
			{
							...
							|| (this._Cargo.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Cargo_Empleado.Remove(this);
					}
					this._Cargo.Entity = value;
					if ((value != null))
					{
						value.Cargo_Empleado.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Empleado_Cargo_Empleado", Storage="_Empleado", ThisKey="EmpleadoId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
